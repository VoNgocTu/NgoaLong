...
newButton("Reload")
btnId1 := newButton("ID1: ")
btnId2 := newButton("ID2: ")
btnCorpsCoordinate := newButton("Toạ độ quân đoàn: ")
...
newButtonLine(name, callback := (*) => Reload) {
    global guiMain
    guiMain.Add("Text", "xm", "First name:")
    newButton("test", "ym w50 h30")
    guiMain.Add("Hotkey", "ym w50 h30", "")
}

newButton(name, options := "w200 h30", callback := (*) => Reload) {
    global guiMain
